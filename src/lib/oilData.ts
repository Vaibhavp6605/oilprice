...
export const dailyData: DailyData[] = [
  ...
  { date: "2026-04-01", brent_usd_barrel: 115.6, wti_usd_barrel: 106.8, dubai_usd_barrel: 160.4, us_gas_avg_gallon: 3.92, us_diesel_avg_gallon: 4.72, strait_hormuz_daily_ships: 3, iran_production_mbpd: 0.08, key_event: "DAY 33: Iran activates sleeper cells across Gulf states", war_day: 33, brent_vs_prewar_pct: 58.1, gas_vs_prewar_pct: 31.5, gas_change_from_prewar_dollars: 0.94, phase: "Week 5 Escalation" },
];
